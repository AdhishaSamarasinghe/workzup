...
export default function ApplicationMessagingScreen({ audience }: Props) {
	...
	return (
		<div className="mt-[80px] h-[calc(100vh-80px)] bg-[#f9fafb] p-6 lg:p-8">
			<div className="mx-auto mb-4 w-full max-w-7xl rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-[#111827]">
				{audience === "JOB_SEEKER" ? "Job Seeker Messages" : "Recruiter Messages"}
			</div>

			<div className="mx-auto flex h-[calc(100%-56px)] w-full max-w-7xl overflow-hidden rounded-[20px] border border-gray-100 bg-white shadow-sm">
				<InboxSidebar
				...
				/>
				<div className="relative flex h-full flex-1 flex-col overflow-hidden border-l border-gray-100 bg-[#fcfcfd]">
