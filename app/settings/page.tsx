        ...
        <div className="max-w-[var(--max-width)] mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="flex flex-col lg:flex-row gap-10">
                ...
                <aside className="w-full lg:w-80 flex-shrink-0">
                    <div className="bg-card rounded-[var(--radius)] border border-gray-100 shadow-sm overflow-hidden sticky top-24">
                            ...
                            <ul className="space-y-1.5">
                                {navItems.map((item) => (
                                    <li key={item.id}>
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3.5 px-5 py-3 text-sm font-semibold rounded-[var(--radius)] transition-all duration-200 ${activeTab === item.id
                                                ? "bg-accent text-white shadow-lg shadow-accent/40 translate-x-1"
                                                : "text-muted hover:bg-bg hover:text-gray-900"
                                                }`}
                                        >
                                ...
                                <li className="pt-4 mt-4 border-t border-gray-100">
                                    <button
                                        ...
                                        className="group w-full flex items-center gap-3.5 px-5 py-3 text-sm font-semibold text-red-500 rounded-[var(--radius)] hover:bg-red-50 transition-all duration-200"
                                    >
                ...
                <main className="flex-1 space-y-10">
                    <div className="animate-in fade-in slide-in-from-top-4 duration-700">
                        ...
                        <p className="mt-2 text-lg text-muted">Customize your profile, set preferences, and manage your security.</p>
                    </div>

                    {activeTab === "account" && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            {/* General Profile */}
                            <div className="bg-card rounded-[var(--radius)] border border-gray-100 shadow-sm overflow-hidden border-t-4 border-t-accent">
                                <div className="p-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                                        <div className="space-y-2.5">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-11 pr-4 py-3.5 bg-bg border border-gray-200 rounded-[var(--radius)] focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent transition-all text-[15px] font-medium"
                                                />
                                            </div>
                                        </div>
                                        <div className="space-y-2.5">
                                            ...
                                            <div className="relative group">
                                                <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-accent transition-colors" />
                                                <input
                                                    type="text"
                                                    value={title}
                                        ...
                                        <div className="space-y-2.5">
                                            ...
                                            <div className="relative group">
                                                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-accent transition-colors" />
                                                <select
                                                    value={userLocation}
                                                    onChange={(e) => {
                                                    ...
                                                    className="w-full pl-11 pr-4 py-3.5 bg-bg border border-gray-200 rounded-[var(--radius)] focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent transition-all text-[15px] font-medium appearance-none"
                                                >
                                        ...
                                        <div className="md:col-span-2 space-y-2.5">
                                            ...
                                            <textarea
                                                ...
                                                rows={4}
                                                className="w-full px-5 py-4 bg-bg border border-gray-200 rounded-[var(--radius)] focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent transition-all text-[15px] font-medium resize-none leading-relaxed"
                                            />
                                    ...
                                    <div className="flex justify-end gap-3 pt-6 border-t border-gray-50">
                                        <button className="px-6 py-3 text-sm font-bold text-gray-600 hover:bg-bg rounded-[var(--radius)] transition-all">Cancel</button>
                                        <button
                                            onClick={() => handleSave("profile")}
                                            disabled={isLoading}
                                            className="px-8 py-3 bg-accent text-white rounded-[var(--radius)] text-[15px] font-bold shadow-lg shadow-accent/20 hover:bg-accent/90 hover:shadow-accent/40 active:scale-95 transition-all disabled:opacity-50 flex items-center gap-2.5"
                                        >
                            ...
                            <div className="bg-red-50/40 rounded-[var(--radius)] border border-red-100 overflow-hidden group">
                                <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                                    ...
                                    <button className="px-8 py-3.5 bg-card text-red-600 border-2 border-red-100 hover:bg-red-600 hover:text-white hover:border-red-600 rounded-[var(--radius)] text-[15px] font-bold shadow-sm transition-all duration-300 flex items-center gap-3 flex-shrink-0 group-hover:shake">
                                ...
                                <div className="p-8">
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted">Manage your password and account access.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-8 max-w-3xl">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-2.5">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="••••••••"
                                                    className="w-full px-5 py-3.5 bg-bg border border-gray-200 rounded-[var(--radius)] focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent transition-all text-sm"
                                                />
                                            </div>
                                            <div className="space-y-2.5">
                                        ...
                                        <div className="flex justify-start">
                                            <button
                                                ...
                                                className="px-8 py-3 bg-accent text-white rounded-[var(--radius)] text-[15px] font-bold shadow-md hover:bg-accent/90 transition-all disabled:opacity-30 flex items-center gap-2.5"
                                            >
                                                Update Password
                                            </button>
                                        </div>
                                ...
                                <div className="p-8">
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted">Choose when and how you want to be notified.</p>
                                        </div>
                                    </div>
                                        ...
                                        {[
                                            ...
                                            <div key={item.id} className="py-6 flex items-center justify-between gap-6 first:pt-0 last:pb-0">
                                                ...
                                                <button
                                                    ...
                                                    className={`relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 ${item.state ? "bg-accent" : "bg-gray-200"}`}
                                                >
                                                    <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-card shadow ring-0 transition duration-200 ease-in-out ${item.state ? "translate-x-5" : "translate-x-0"}`} />
                                                </button>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="p-8">
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted">Track your work quality and historical reputation.</p>
                                        </div>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                                        <div className="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-[var(--radius)] p-6 text-white shadow-lg shadow-yellow-100">
                                        ...
                                        <div className="col-span-1 md:col-span-2 bg-bg rounded-[var(--radius)] p-6 border border-gray-100">
                                            ...
                                            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                                                {Object.entries(ratings?.workQualities || {}).map(([key, value]) => (
                                                    <div key={key} className="space-y-1.5">
                                                        <div className="flex justify-between items-center text-xs font-bold text-muted capitalize">
                                                            <span>{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                                                            <span className="text-accent">{value}/5.0</span>
                                                        </div>
                                                        <div className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                                            <div
                                                                className="h-full bg-accent/100 transition-all duration-1000"
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-accent/10/50 rounded-[var(--radius)] p-6 border border-accent/20 flex items-center gap-4">
                    ...
                    {activeTab === "privacy" && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="bg-card rounded-[var(--radius)] border border-gray-100 shadow-sm overflow-hidden border-t-4 border-t-accent-2">
                                <div className="p-8">
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted">Control your visibility and data privacy settings.</p>
                                        </div>
                                    </div>
                                        ...
                                        <div className="py-8 flex items-center justify-between gap-8 first:pt-0">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-1">
                                                    ...
                                                    {profileVisibility ? (
                                                        <span className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-accent-2 bg-accent-2/10 px-2.5 py-1 rounded-full">
                                                            <Eye className="w-3 h-3" /> Public
                                                        </span>
                                                    ) : (
                                                        <span className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-muted bg-bg px-2.5 py-1 rounded-full">
                                            ...
                                            >
                                                <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-card shadow ring-0 transition duration-200 ease-in-out ${profileVisibility ? "translate-x-5" : "translate-x-0"}`} />
                                            </button>
                                        </div>
                    ...
                    {activeTab === "preferences" && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="bg-card rounded-[var(--radius)] border border-gray-100 shadow-sm overflow-hidden border-t-4 border-t-gray-500">
                                <div className="p-8">
                                    <div className="flex items-center gap-3 mb-8">
                                        <div className="p-2.5 bg-bg rounded-xl text-gray-600">
                                            <Settings className="w-5 h-5" />
                                        </div>
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900">General Preferences</h2>
                                            <p className="text-sm text-muted">Customize your overall experience and interface.</p>
                                        </div>
                                    </div>
                                            ...
                                            <div className="flex bg-gray-100 p-1 rounded-[var(--radius)] w-fit">
                                                {["light", "dark", "system"].map((t) => (
                                                    <button
                                                        ...
                                                        className={`px-5 py-2 text-xs font-bold uppercase tracking-wider rounded-xl transition-all ${theme === t ? "bg-card text-accent shadow-sm" : "text-muted hover:text-gray-700"}`}
                                                    >
                                                        {t}
                                                    </button>
                                                ))}
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-10 border-t border-gray-50">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted">Set your preferred language and date formatting.</p>
                                                </div>
                                            </div>
                                            <select
                                                value={language}
                                                ...
                                                className="px-5 py-3 bg-bg border border-gray-200 rounded-[var(--radius)] focus:outline-none focus:ring-4 focus:ring-accent/10 focus:border-accent text-sm font-bold min-w-[200px]"
                                            >
                    ...
                    {saveStatus === "success" && (
                        <div className="fixed bottom-10 right-10 animate-in slide-in-from-right-10 duration-500 z-50">
                            <div className="bg-gray-900/90 backdrop-blur-md text-white px-8 py-4 rounded-[var(--radius)] shadow-2xl flex items-center gap-4 border border-white/10">
                                <div className="w-6 h-6 bg-accent-2 rounded-full flex items-center justify-center">
                    ...
                    {saveStatus === "error" && (
                        <div className="fixed bottom-10 right-10 animate-in slide-in-from-right-10 duration-500 z-50">
                            <div className="bg-red-600/95 backdrop-blur-md text-white px-8 py-4 rounded-[var(--radius)] shadow-2xl flex items-center gap-4 border border-red-500/30">
            ...
            {showLogoutModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="bg-card rounded-[var(--radius)] p-8 max-w-sm w-full shadow-2xl border border-gray-100 animate-in zoom-in-95 duration-300">
                        <div className="flex flex-col items-center text-center">
                            <div className="w-16 h-16 bg-red-50 rounded-[var(--radius)] flex items-center justify-center text-red-500 mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-3 w-full">
                                <button
                                    ...
                                    className="px-4 py-3 text-sm font-bold text-gray-600 bg-bg hover:bg-gray-100 rounded-[var(--radius)] transition-all disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    disabled={isLoggingOut}
                                    className="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-[var(--radius)] shadow-lg shadow-red-100 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                >
                                    {isLoggingOut ? (
                                        <>
...
function ExpItem({ exp }: { exp: Experience }) {
    return (
        <div className="p-5 bg-card border border-gray-100 rounded-[var(--radius)] group hover:border-yellow-200 transition-all">
            ...
            <p className="text-sm text-gray-600 bg-bg p-3 rounded-xl italic border-l-4 border-yellow-400">&quot;{exp.feedback}&quot;</p>
        </div>
    );
}
