    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            try {
                ...
                if (statusRes.role === "JOB_SEEKER") {
                    setError("User registered as a Job Seeker. Please use the job seeker portal to log in.");
                    setLoading(false);
                    return;
                }
            } catch (err) {
                    ...
                    <div className="w-full max-w-[500px] bg-white rounded-xl shadow-lg shadow-gray-200/50 p-8 sm:p-10 mb-auto mt-4 sm:mt-8 relative animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="flex w-fit">
                                ...
                                <Link href="/auth/register/recruiter" className="px-8 py-2 bg-white text-gray-500 font-semibold rounded-r-md border border-gray-300 border-l-0 hover:bg-gray-50 transition-colors">
                                    Register
                                </Link>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center pt-2">
                                ...
                                <Link href="/auth/register/recruiter" className="text-sm font-bold text-black hover:underline">
                                    Register now
                                </Link>
                            </div>
