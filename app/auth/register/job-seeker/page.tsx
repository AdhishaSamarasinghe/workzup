        ...
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            >
                ...
                <div className="flex w-full flex-col justify-center items-center bg-[#F9FAFB] p-8 lg:w-2/3 lg:p-12 relative overflow-y-auto">
                    ...
                    <div className="w-full max-w-[700px] bg-white rounded-xl shadow-lg shadow-gray-200/50 p-8 sm:p-10 mb-auto mt-4 sm:mt-8 relative animate-in fade-in slide-in-from-bottom-4 duration-500">
                        {/* Tabs */}
                        <div className="flex justify-center mb-6">
                            <div className="flex w-fit">
                                <Link href="/auth/login" className="px-8 py-2 bg-white text-gray-500 font-semibold rounded-l-md border border-gray-300 border-r-0 hover:bg-gray-50 transition-colors">
                                    Login
                                </Link>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div className="relative">
                                    <input
                                        ...
                                        className="block w-full rounded-md border-0 bg-[#E0E0E0] py-3.5 pl-4 pr-10 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#6B8BFF] sm:text-[15px] sm:leading-6"
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 items-center">
                                <div className="flex items-center space-x-4 rounded-md border border-gray-300 px-4 py-3.5">
                                    ...
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-[#6B8BFF]"
                                        />
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-[#6B8BFF]"
                                    />
